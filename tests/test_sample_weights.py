...
class TestCalculateOptimalBandwidth(unittest.TestCase):
    ...
    def test_basic_calculation(self):
        ...
        bandwidth, info = calculate_optimal_bandwidth(
            self.locations, n_bandwidths=10, min_bw=0.5, max_bw=3.0
        )
...
class TestWeightSamples(unittest.TestCase):
    ...
    def test_load_weights(self):
        ...
        result = weight_samples(
            method="load", trainsamps=self.sample_ids, weightdf=weights_df
        )
...
class TestMakeKDWeights(unittest.TestCase):
    ...
    def test_with_caching(self):
        ...
        # First call
        weights1 = _make_kd_weights(
            self.locations, cache_bandwidth=True, n_bandwidths=10
        )
...
class TestLoadSampleWeights(unittest.TestCase):
    ...
    def test_basic_loading(self):
        ...
        sample_ids = ["A", "B", "C", "D"]
        weights_df = pd.DataFrame(
            {"sampleID": sample_ids, "sample_weight": [0.1, 0.2, 0.3, 0.4]}
        )
    ...
    def test_missing_sample(self):
        ...
        weights_df = pd.DataFrame({"sampleID": ["A", "B"], "sample_weight": [0.5, 0.5]})
    ...
    def test_invalid_dataframe(self):
        ...
        weights_df = pd.DataFrame(
            {"id": ["A", "B"], "weight": [0.5, 0.5]}  # Wrong column name
        )
