...
class TestAnalysisTFData:
    ...
    @pytest.mark.parametrize("method,kwargs,expected_format", [
    ...
    def test_holdout_methods_use_indexset(self, genotype_data, basic_config, method, kwargs, expected_format):
    ...
    def test_all_methods_use_make_tf_dataset(self, mock_make_tf_dataset, genotype_data, basic_config):
