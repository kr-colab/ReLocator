...
class TestIndexSetRandomSplit:
    ...
    def test_random_split_with_na_separate(self):
        ...
        na_mask = np.array([False, False, True, False, True, False, False, True, False, False])
        idx_set = IndexSet.random_split(n=10, seed=42, na_mask=na_mask, na_action='separate')
    ...
    def test_random_split_with_na_exclude(self):
        ...
        idx_set = IndexSet.random_split(n=5, seed=42, na_mask=na_mask, na_action='exclude')
