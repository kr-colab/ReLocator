...
class TestVerbosityControl:
    ...
    def test_verbose_splits_holdout(
        self, genotype_data, sample_data_file, capsys, tmp_path
    ):
    ...
    def test_verbose_batch_size_cpu(
        self, genotype_data, sample_data_file, capsys, tmp_path
    ):
    ...
    def test_verbose_batch_size_auto(
        self, genotype_data, sample_data_file, monkeypatch, capsys, tmp_path
    ):
