...
class TestBandwidthOptimizationIntegration(unittest.TestCase):
    ...
    def test_kfold_bandwidth_optimization(self):
        ...
        with patch(
            "locator.sample_weights.get_global_bandwidth_optimizer"
    ...
    def test_kfold_bandwidth_restoration(self):
        ...
        with (
            patch.object(locator, "train_holdout"),
    ...
    def test_bootstrap_bandwidth_optimization(self):
        ...
        try:
            ...
            with patch.object(locator, "train", side_effect=mock_train_impl):
                try:
                    locator.run_bootstraps(self.genotypes, self.samples, n_bootstraps=2)
                except Exception:
    ...
    def test_bootstrap_bandwidth_restoration(self):
        ...
        with (
            patch.object(locator, "train", side_effect=mock_train_impl),
            patch.object(
    ...
    def test_performance_improvement(self):
        ...
        with (
            patch.object(locator_no_cache, "train_holdout"),
            patch.object(
        ...
        with (
            patch.object(locator_cache, "train_holdout"),
...
class TestKDEWeightsDisabled(unittest.TestCase):
    ...
    def test_no_kde_weights(self):
        ...
        config = {
            ...
            "max_epochs": 1,
            "keras_verbose": 0,
            "weight_samples": {"enabled": False},  # Disabled
        }
    ...
    def test_histogram_weights(self):
        ...
        config = {
            ...
            "max_epochs": 1,
            "keras_verbose": 0,
            "weight_samples": {"enabled": True, "method": "histogram"},  # Not KDE
        }
